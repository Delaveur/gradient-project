<?php
$page_title = "Загородный посёлок “Старочеркасская Ривьера”";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Загородный посёлок “Старочеркасская Ривьера”</h1>
        <div class="text-lg text-gray-500">Россия, станица Старочеркасская, Аксайский район Ростовской области
        </div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Концепция коттеджного поселка</p>
          <p>Участок под проектирование посёлка, расположен на правом берегу реки Дон, в 30 км от города Ростов-на-Дону. Расположен в экологически чистом месте, в туристическо - рекреационной Особой Экономической Зоне Ростовской области.</p>
          <p>Концепция посёлка включает в себя застройку из домов разной площади, разного стилистического решения. В посёлке предполагается застройка<br>
            Три типа домов, различных по площади.  В дальнейшем планировалось запроектировать 9 типов, каждого решения по 3 дома разной площади.</p>
          <p>Участок #1, эскизный проект коттеджа <br>
            Общая площадь проектирования 362 м.кв.<br>
            Стадия Эскиз</p>
          <p>Участок #2, эскизный проект коттеджа <br>
            Общая площадь проектирования 252 м.кв.<br>
            Стадия Эскиз</p>
          <p>Участок #3, эскизный проект коттеджа <br>
            Общая площадь проектирования 463 м.кв.<br>
            Стадия Эскиз</p>
        </div>
      </div>
    </div>
