<?php
$page_title = "Жилая застройка остров Кишь (Иран)";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Жилая застройка остров Кишь (Иран)</h1>
        <div class="text-lg text-gray-500">2011 Иран, о.Кишь
        </div>
      </div>
