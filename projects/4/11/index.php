<?php
$page_title = "Индивидуальный жилой дом, коттеджный поселок Усадьба Бергов";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Индивидуальный жилой дом, коттеджный поселок Усадьба Бергов</h1>
        <div class="text-lg text-gray-500">2011 Россия, Московская область
        </div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Общая площадь проектирования  25 000  м.кв.
            <br />
            Концепция
          </p>
          <p>Остров, располагается в Персидском заливе.
            <br />
            Участок под застройку, располагается в центральной части острова, примыкает к жилому массиву, с развитой инфраструктурой.
          </p>
        </div>
      </div>
    </div>
