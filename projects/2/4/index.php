<?php
$page_title = "Гостиничный комплекс СГАФКСиТ";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Гостиничный комплекс СГАФКСиТ</h1>
        <div class="text-lg text-gray-500">2012 Россия, Смоленск
        </div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Общая площадь реконструкции 25 000  м.кв.
            <br />
            Стадия П внутренних инженерных систем для строительства многофункционального  гостиничного комплекса
          </p>

          <p>Общежитие является частью существующего Федерального Государственного Образовательного Бюджетного Учреждения Высшего Профессионального Образования &laquo;СГАФКСиТ&raquo; расположенного в г. Смоленске, включено в его общую структуру генерального плана.
            <br />
            Проектируемое общежитие располагается в северной части территории учебного комплекса «СГАФКСиТ».
            <br />
            В состав комплекса, состоящего из стилобатной и высотной частей,  входят:
            <br />
            -   приемно-вестибюльная группа помещений и помещения общественного назначения;
            <br />
            -   конференц-зал на385 чел. с прилегающей конференц-зоной;
            <br />
            ...
            <br />
            -   зоны отдыха и дополнительные помещения, повышающие комфорт проживания;
            <br />
            -   помещения для самостоятельных занятий студентов.
          </p>
        </div>
      </div>
    </div>
