  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">ЗАО Райффайзенбанк</h1>
        <div class="text-lg text-gray-500">2010 Россия, г. Петропавловск-Камчатский
        </div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Центральное отделение по Камчатскому краю ЗАО &laquo;Райффайзенбанк&raquo;
            <br />
            Общая площадь реконструкции 3 000  м.кв.
            <br />
            Стадия П по реконструкции здания
          </p>

          <p>Проектом разработана поэтапная реконструкция здания ЗАО «Райффайзенбанк», расположенного на ул. Артиллерийская, дом 8.</p>

          <p>Основная сложность при реализации проекта  заключалась в отсутствии какой-либо исходной документации по зданию построенному в начале 20 века и неоднократно перестраиваемого.</p>

          <p> Дополнительным условием, характерным для подобных объектов, предусмотреть на этапе разработки проектной документации, проведение строительно- монтажных работ без приостановки работы филиала. Таким образом, специалистами компании было проведено, в ограниченное время, детальное обследование строительных конструкций и инженерных сетей.</p>

          <p> Вопрос о «Непрерывной работе» был решен путем условного разделения площадей здания подлежащих реконструкции на этапы и поэтапного перемещения персонала в зависимости от фазы проведения работ.</p>
