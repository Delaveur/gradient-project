<?php
$page_title = "Производство по изготовлению каминов";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Производство по изготовлению каминов</h1>
        <div class="text-lg text-gray-500">2010 Россия, Владимирская область
        </div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Общая площадь реконструкции 5 000  м.кв.
            <br />
            Стадия П
          </p>
          <p>Согласно поставленной задачи, по реконструкции существующего здания с пристройкой административно-бытового комплекса, специалисты компании интегрировали производственную линию по производству каминов</p>
        </div>
      </div>
    </div>
  </div>
