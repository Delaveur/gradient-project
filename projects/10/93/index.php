<?php
$page_title = "Офисное пространство | IT КЛАСТЕР компании «КЛЮЧ»";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Офисное пространство | IT КЛАСТЕР компании «КЛЮЧ»</h1>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Офисное пространство для IT компании, находится на последнем этаже бизнес-центра Трёхгорная Мануфактура, по адресу г. Москва, ул. Рочдельская дом 15. <br>
            Проектом предусмотрена открытая планировка рабочих мест, специальная лаборатория для проведения испытаний, лекторий и кафе.</p>
          <p>S общая: 766 м.кв. </p>
          <p>Стадии<br>
            Проект<br>
            Реализация<br>
            Монтаж инженерных систем выполнен компанией МЕГАПОЛИС</p>
        </div>
      </div>
    </div>
  </div>
