<?php
$page_title = "Интерьер офиса компании Сахалинская Энергия  Сollaboration area";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Интерьер офиса компании Сахалинская Энергия Сollaboration area</h1>
        <div class="text-lg text-gray-500">2013 Россия, Южно-Сахалинск
        </div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>Общая площадь проектирования 1 100&nbsp;м.кв</p>
          <p align="justify"> Описание проекта: дизайн интерьера SEB-2 офисная зона для дистанционного сотрудничества персонала с нефтедобывающими платформами, расположенных в зоне до  670km  в Охотском море от Южно-Сахалинска. </p>
          <p align="justify"> Цели проекта:<br>
            - перепрофилирование существующих офисных помещений для новых функций. <br>
            - Оборудование помещений необходимым телекоммуникационным оборудованием.<br>
            - Соблюдение требований, связанных с удобством работы сотрудников. </p>
        </div>
      </div>
    </div>
  </div>
