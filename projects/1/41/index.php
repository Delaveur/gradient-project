  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_280px]">
    ...
    <div class="lg:order-1">
      ...
      <div class="mb-6 lg:mb-8">
        ...
        <div class="text-lg text-gray-500">2012 Россия, г. Владимир</div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-300px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p align="justify">Общая площадь проектирования 26&nbsp;375 м.кв.
            <br />
          ...
          <p align="justify">Здание торгового центра расположено в историческом центре города Владимир, на улице Дворянская, рядом со стадионом &laquo;Торпедо&raquo;.</p>

          <p align="justify"> Совместно с консалтинговым агентством «ETERNA real estate» была разработана торговая концепция объекта, которая соответствует экономическим потребностям  выбранного места под проектирование. Учитывая окружающую историческую застройку, архитектура здания с фасадами из светлого камня интегрируется в белокаменную застройку центра города.</p>

          <p align="justify"> Реклама и вывески выполнены в едином стиле - это позволяет растворить новое здание  в ткани улицы, в то же время большие витринные окна привлекают внимание. За счёт естественного рельефа на участке, парковка и разгрузка товара располагается в подземных уровнях. Ресторан и «фуд-корт» выходят витринными окнами на большую открытую террасу, и лестницей ведущей в парк с небольшим озером. Проектом предлагается обустроить набережную, организовать пляж в летнее время и каток &ndash; зимой. Дополнительная площадка для отдыха, будет привлекать горожан для посещения торгового центра.</p>
        </div>
      </div>
    </div>
  </div>
