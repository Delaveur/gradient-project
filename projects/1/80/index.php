<?php
$page_title = "Международный центр шоу-румов Expolon";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Международный центр шоу-румов Expolon</h1>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-400px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p align="justify">Международный центр шоу-румов Expolon  расположен в здании по адресу: ул. Косинская, д. 9, стр.21.</p>
          <p align="justify"> В основу концепции проекта, не имеющего аналогов на российском рынке, легла идея создания бизнес-парка модных европейских брендов обуви, женской, мужской и детской одежды, а также меховых изделий и аксессуаров.</p>
          <p align="justify"> Международный центр Expolon станет первым в России проектом, совмещающим в себе офисы и шоу-румы модных европейских брендов.</p>
          <p align="justify"> Арендаторами выставочных и офисных площадей в международном центре Expolon будут иностранные компании fashion-индустрии, стремящиеся выйти на российский рынок с минимальными затратами. В центре шоу-румов Expolon будет представлена вся деловая инфраструктура, необходимая для дистрибуции товаров на российском рынке моды.</p>
        </div>
      </div>
    </div>
  </div>
