<?php
$page_title = "Бизнес-центр ул.Алексея Свиридова";
  ...
  <div class="flex flex-col lg:grid lg:grid-cols-[1fr_240px] lg:gap-8 xl:grid-cols-[1fr_340px]">
    ...
    <div class="lg:order-1 md:mt-[-72px]">
      ...
      <div class="mb-6 lg:mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Бизнес-центр ул.Алексея Свиридова</h1>
        <div class="text-lg text-gray-500">г. Москва ул. А.Свиридова 17А</div>
      </div>
    ...
    <div class="lg:order-2 lg:h-[calc(100vh-300px)] lg:sticky lg:top-8 lg:overflow-y-auto custom-scrollbar">
      <div class="prose max-w-none lg:pr-4">
        <div class="space-y-4 text-gray-600">
          <p>
            Общая площадь проектирования 3 990 м.кв.&nbsp;<br>
            Конкурс </p>
          <p> В проекте офисного центра, было решено несколько функциональных задач. Сохранение взрослых деревьев и организация сквера. При ширине здания 8,4 метра, на участке возможно разместить полуподземную механизированную парковку. Компактизирование объёма здание в узкую структуру, позволило отказаться от внутренних конструктивных элементов, и сделать офисное пространство со свободной планировкой. Арендуемая площадь этажа составляет 300 м.кв, и разбита на два крыла по 100 и 200 м.кв. - наиболее дефицитный формат офисных площадей. Достигнута максимальная эффективность сдаваемой площади за счет минимизации коммуникационных пространств (холлов, коридоров и т.д.). Полезная площадь составляет 82%.  Все функции здания направлены на удовлетворение потребностей сотрудников и в то же время предполагают высокую эффективность использования энергии. Использование естественного освещения, за счёт узкого фасада, значительно снижает эксплуатационные затраты и, кроме этого, улучшает психологический комфорт находящихся в здании людей. </p>
        </div>
      </div>
    </div>
  </div>
